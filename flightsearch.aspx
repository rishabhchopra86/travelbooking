<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="flightsearch.aspx.vb" Inherits="flightsearch" %>
                            ...
                            <div class="booking-item-container">
                                <div class="booking-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><span class="booking-item-price">$158</span><span>/person</span>
                            ...
                            <div class="booking-item-container">
                                <div class="booking-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><span class="booking-item-price">$319</span><span>/person</span>
                                            <p class="booking-item-flight-class">Class: First</p><a class="btn btn-primary" href="#">Select</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="booking-item-container">
                                <div class="booking-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><span class="booking-item-price">$484</span><span>/person</span>
                                            <p class="booking-item-flight-class">Class: First</p><a class="btn btn-primary" href="#">Select</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="booking-item-container">
                                <div class="booking-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><span class="booking-item-price">$450</span><span>/person</span>
                                            <p class="booking-item-flight-class">Class: Economy</p><a class="btn btn-primary" href="#">Select</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="booking-item-container">
                                <div class="booking-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><span class="booking-item-price">$245</span><span>/person</span>
                                            <p class="booking-item-flight-class">Class: First</p><a class="btn btn-primary" href="#">Select</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="booking-item-container">
                                <div class="booking-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><span class="booking-item-price">$222</span><span>/person</span>
                                            <p class="booking-item-flight-class">Class: Economy</p><a class="btn btn-primary" href="#">Select</a>
                                        </div>
                                    </div>
                                </div>
